...
class ProductDetailModel {
  ...
  factory ProductDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    return ProductDetailModel(
      ...
      tech: _getGiaTri('cong_nghe'),
      power: _getGiaTri('cong_suat'),
      efficiency: _getGiaTri('hieu_suat'),
      weight: _getGiaTri('khoi_luong'),
      size: _getGiaTri('kich_thuoc'),
      price: _getPrice(),
    );
  }
}
